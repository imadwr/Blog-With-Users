...
class BlogPost(db.Model):
    ...
    comments = relationship("Comment", back_populates="comment_blog_post")
...
class Comment(db.Model):
    ...
    comment_blog_post = relationship("BlogPost", back_populates="comments")
...
def show_post(post_id):
    ...
    all_comments = Comment.query.filter_by(blog_post_id=post_id).all()
    if comment_form.validate_on_submit():
        if not current_user.is_authenticated:
            flash("You should log in to be able to submit comments.")
            return redirect(url_for("login"))
